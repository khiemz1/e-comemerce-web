            ...
            <div class="info-container2">
                <div class="info-shoe">
                    ...
                    <div class="info-shoe_product">
                        <p class="info-shoe_product_name">${SP.tenSP} - ${size}</p>
                        <p class="info-shoe_product_amount">x${quantity}</p>
                    </div>
                    ...
                    <div class="info-form_button">
                        <button class="btn" type="button" onclick="thanhToan()">Thanh Toán</button>
                    </div>
                </div>
            </div>
        </div>
